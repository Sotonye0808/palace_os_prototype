    ...
    <div className="min-h-screen bg-background text-text">
      ...
      <header className="bg-bg/90 backdrop-blur-sm p-6 border-b border-border/50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <Link href="/menu" className="text-text-brand hover:underline">
            Continue Shopping
          </Link>
        </div>
      </header>
          ...
          <div className="bg-card rounded-xl border border-border/50 p-6">
           ...
           <div className="bg-card rounded-xl border border-border/50 p-6">
             <h2 className="text-2xl font-semibold mb-4">Payment</h2>
              ...
              {paymentStatus && (
                <div className={"mb-4 p-4 rounded-lg " + (paymentStatus.includes('successful') ? 'bg-green-50 border border-green-200 text-green-800' 
